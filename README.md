...
```bash
# Install
git clone https://github.com/ArliT1-F/torch2grid.git
cd torch2grid
./install.sh
...
- **Issues**: [GitHub Issues](https://github.com/ArliT1-F/torch2grid/issues)
- **Discussions**: [GitHub Discussions](https://github.com/ArliT1-F/torch2grid/discussions)
