...
def main():
    """Main entry point for torch2grid CLI."""
    if len(sys.argv) < 2:
        ...
        print("\nFor more information, visit: https://github.com/your-username/torch2grid")
        return
    ...
    for i, arg in enumerate(sys.argv):
        if arg == "--load-plugin" and i + 1 < len(sys.argv):
            ...
            try:
                ...
                print("Please ensure the file contains a valid TransformerPlugin class.")
                return 1
    ...
    try:
        ...
        print("Please ensure the file is a valid PyTorch model (.pt, .pth, or .pkl).")
        return 1
